...
SECRET_KEY = 'django-insecure-%+l_kogx$4e6l@sb9-#sw)20*%oa47jcikjo()4m-u&$0jjtmm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['localhost','sirchimex.pythonanywhere.com']
